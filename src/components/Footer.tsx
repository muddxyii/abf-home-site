        ...
        <footer className="footer footer-center p-10 bg-base-200 text-base-content" itemScope itemType="http://schema.org/Organization">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-7xl">
                <div className="text-left">
                    ...
                    <a href="mailto:info@anybackflow.com" className="link link-hover" itemProp="email">info@anybackflow.com</a>
                ...
                <div className="text-left">
                    ...
                    <p itemProp="areaServed">Metro Phoenix area including Apache Junction, Avondale, Buckeye, Care Free, Cave Creek, Chandler, and more.</p>
                </div>
            </div>
